...
#### [Soporte de Bases de Datos en Contenedor de Oracle (CDB/PDB)](../user-guide/create_a_connector.md)
...
#### [TLS / Conexiones Seguras](../user-guide/configure_snapshot_engine.md)
...
#### [Nivel de Registro de Debezium Ajustable en Tiempo de Ejecución](../getting-started/configuration.md)
